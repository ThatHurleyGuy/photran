...
//import org.eclipse.rephraserengine.core.vpg.refactoring.VPGRefactoring.PreconditionFailure;
 ...
 */
public class MakeTypesafeRefactoring extends FortranEditorRefactoring
{
    ...
    private IASTListNode<IBodyConstruct> constructDeclarations(final ScopingNode scope)
    {
        ...
        newStmts.append("INTERFACE\n blah\n  blah\nEND INTERFACE" + EOL); //$NON-NLS-1$
    ...
    {
        return "Make Typesafe..."; //$NON-NLS-1$

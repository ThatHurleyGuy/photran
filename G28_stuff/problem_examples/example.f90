This DOES NOT cause a compile error but it would be nice for us to catch it beforehand.
...
! Notice that here Area_Circle can be changed to a string or anything and it will compile
